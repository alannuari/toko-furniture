...
<header class="{{ Route::current()->getName() == 'index' ? 'absolute ' : '' }}w-full z-50 px-4">
    <div class="container mx-auto py-5">
        <div class="flex flex-stretch items-center">
            ...
            <div class="w-auto">
            <ul
                class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center  text-black {{ Route::current()->getName() == 'index' ? 'md:text-white' : '' }}"
                id="menu"
            >
                ...
                @auth
                    <li class="mx-3 py-6 md:py-0">
                    <a href="{{ route('dashboard.index') }}" class="hover:underline"
                        >Dashboard</a
                    >
                    </li>
                @endauth
